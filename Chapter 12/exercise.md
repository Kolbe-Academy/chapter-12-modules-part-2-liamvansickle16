...
test(sorted(wordset(["now", "is", "time", "is", "now", "is", "is"])) == sorted(["is", "now", "time"]))
test(sorted(wordset(["I", "a", "a", "is", "a", "is", "I", "am"])) == sorted(["I", "a", "am", "is"]))
test(sorted(wordset(["or", "a", "am", "is", "are", "be", "but", "am"])) == sorted(["a", "am", "are", "be", "but", "is", "or"]))
